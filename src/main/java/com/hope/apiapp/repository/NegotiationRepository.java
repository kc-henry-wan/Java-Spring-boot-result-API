...
public interface NegotiationRepository extends JpaRepository<Negotiation, Long> {
	...
	@Query("SELECT n.negotiationId AS negotiationId, j.jobRef AS jobRef, j.jobDate AS jobDate, "
			...
			+ " n.status AS status, n.reason AS reason, n.updatedUserId AS updatedUserId, "
			...
			+ " LEFT OUTER JOIN Pharmacist p ON n.pharmacistId = p.pharmacistId " + "WHERE n.status = :status ")
	Page<NegotiationProjection> getNegotiationByStatus(@Param("status") String status, Pageable pageable);
